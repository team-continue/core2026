...
PathPlanner::PathPlanner(const Settings& settings) : settings_(settings) {}
...
PathPlanner::PlanResult PathPlanner::plan(
  ...
  GridIndex goal_cell;
  if (!worldToGrid(map, start.pose.position.x, start.pose.position.y,
                   start_cell) ||
      !worldToGrid(map, goal.pose.position.x, goal.pose.position.y,
                   goal_cell)) {
...
bool PathPlanner::computePath(const nav_msgs::msg::OccupancyGrid& map,
...
void PathPlanner::reconstructPath(const nav_msgs::msg::OccupancyGrid& map,
...
bool PathPlanner::worldToGrid(const nav_msgs::msg::OccupancyGrid& map,
...
void PathPlanner::gridToWorld(const nav_msgs::msg::OccupancyGrid& map,
...
bool PathPlanner::isOccupied(const nav_msgs::msg::OccupancyGrid& map,
