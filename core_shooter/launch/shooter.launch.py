    ...
    left_aim_bot_node = Node(
        ...
        parameters=[
            shooter_params,
            {
                ...
                "pitch_min_angle": -1.44,
                "pitch_max_angle": 0.0,  # 3.14,
                ...
                "zone.pitch_zone2_upper": 0.0,  # 3.14,
                "zone.pitch_zone2_lower": -1.44,
                "zone.pitch_zone2_upper_limit": 0.0,  # 3.14,
                "zone.pitch_zone3_lower": -1.2,
                "zone.pitch_zone3_upper": 1.0,
                "zone.pitch_zone1_upper": 0.0,  # 3.14,
    ...
    right_aim_bot_node = Node(
        ...
        parameters=[
            shooter_params,
            {
                ...
                "zone.yaw_zone2_end": 1.0,
                "zone.yaw_zone3_end": 2.2,
                "zone.pitch_lower_limit": -3.0,
                "zone.pitch_zone2_upper": 0.0,  # 3.14,
                "zone.pitch_zone2_lower": -3.0,
                "zone.pitch_zone2_upper_limit": 0.0,  # 3.14,
