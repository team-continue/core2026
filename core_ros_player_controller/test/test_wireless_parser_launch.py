...
class TestWirelessParserNode(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.rotation_flag_msg = None
        self.rotation_flag_event = threading.Event()
        self.node.create_subscription(Bool, "/rotation_flag", self._on_rotation_flag, 10)
    ...
    def _on_rotation_flag(self, msg: Bool):
        self.rotation_flag_msg = msg
        self.rotation_flag_event.set()
    ...
    def test_manual_mode_outputs_and_new_bit_mapping(self):
        ...
        msg.data = [0b11001010, 127, 64, 0b00000000, 0, 0, 0]
        ...
        self.rotation_flag_event.clear()
        self.wireless_pub.publish(msg)
        ...
        self.assertIsNotNone(self.rotation_flag_msg)
        self.assertTrue(self.rotation_flag_msg.data)
    ...
    def test_auto_mode_suppresses_non_manual_and_non_test_topics(self):
        ...
        self.assertFalse(self.rotation_flag_event.wait(timeout=0.5), "Unexpected /rotation_flag in auto mode")
