...
=== "実機"
    ...
    > SSH経由で `ros2 launch` が動かない場合の詳細は[ナビゲーション起動ガイド](navigation.md#起動navigationsh-を使う場合)を参照。
...
=== "実機"
    ...
    > 詳細は[ナビゲーション起動ガイド — navigation.sh を使う場合](navigation.md#起動navigationsh-を使う場合)を参照。
